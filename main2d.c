...
// Question.4 => MPI_Cart_create/shift by C. Eom
...
// Question.4 => 2D Decomposition by C. Eom
...
// Question.4 => 2d ghost exchange routine with Sendrecv by C. Eom
...
/*
// Question.4 => 2d ghost exchange routine with nonblocking by C. Eom
nbxchange_and_sweep_2d(a, f, nx, ny, s, e, b, MPI_COMM_WORLD, nbrleft, nbrright, nbrdown, nbrup);
nbxchange_and_sweep_2d(b, f, nx, ny, s, e, a, MPI_COMM_WORLD, nbrleft, nbrright, nbrdown, nbrup);
*/


// Question.4 => Calculate 2D grid differences by C. Eom 
...
// Question.4 => Define Analytic solution by C.Eom
...
// Question.4 => Compare the results from finite difference method and analytic solution
